 ...
 */
public record ElfAddress(long address)
        implements Comparable<ElfAddress>, Elf32Primitive, Elf64Primitive {
    public static final int ADDRESS_SIZE_32 = 4;
    public static final int ADDRESS_SIZE_64 = 8;
